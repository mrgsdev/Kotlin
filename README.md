...
- Установка среды разработки (IntelliJ IDEA или Android Studio)
- Синтаксис языка и его отличия от других языков
- Переменные и типы данных (val, var, String, Int, Boolean)
...
7. Объявите nullable строковую переменную, присвойте ей значение, затем сделайте её null и продемонстрируйте безопасный доступ.
8. Напишите программу, которая вычисляет и отображает результат сложения, вычитания, умножения и деления двух чисел.
9. Создайте константы для дней недели, используя `val`, и продемонстрируйте их использование в программе.
10. Напишите программу, которая преобразует заданное количество минут в формат часы и минуты (например, 145 минут = 2 часа и 25 минут).
...
2. Создайте программу, которая отображает сообщение на основе оценки студента (A, B, C, D или F), используя выражение `when`.
3. Напишите программу, которая находит максимальное из трех чисел, используя if-else.
4. Создайте простой калькулятор, который выполняет операции (+, -, *, /) на основе ввода пользователя, используя `when`.
5. Напишите программу, которая определяет, является ли число положительным, отрицательным или нулем.
6. Создайте программу, которая проверяет, имеет ли человек право голосовать, на основе его возраста и гражданства.
7. Напишите код, который определяет квадрант точки на координатной плоскости с помощью вложенных операторов if.
8. Создайте программу, которая преобразует числовой день недели (1-7) в его название (Понедельник-Воскресенье) с помощью `when`.
9. Напишите программу, которая определяет, является ли символ гласной или согласной.
10. Создайте простой симулятор светофора, который выводит, что делать (остановиться, приготовиться, ехать) в зависимости от цвета.
